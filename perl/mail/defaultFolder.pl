...
# content with security
   ...
   $searchForm = "folder: " . $page->getDropdownEditable('folderId','','mail','defaultfolder','1', $v_u,$v_s);
   #$searchForm .= "search: " . $page->getInput('searchValue','','');
   #$searchForm .= " " . $page->getButton( '', '', 'load', 'searchMail()');
   ...
   #$page->positionContainerAbsolut("mailFormId", "TOP", "LEFT", 10, 10, 120,10);
