...
#----------------------------------------------------------------------------------------------------------------------
print "<br><br>ES FEHLEN DIE ORIGINALEN PERL SKRIPTE FÜR DAS ALTE MIDNMAP DAS MUSS ERST VOM BACKUP RECHNER GEHOLT WERDEN DANN KANN DIE NEUE MEINDMAPSEITE GEMACHT WERDEN: WICHTIG SIND AUCH DIE STYLESHOEETS UND EVENTUELL VORHANDES JAVASCRIPT DATEIEN !!!!!<br><br><br><br>\n";
