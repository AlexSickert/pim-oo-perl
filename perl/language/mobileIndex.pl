...
$objPage->addStyleSheet($objConfig->cssPath() . 'mobileLanguage.css');
$objPage->addJavaScript($objConfig->jsPath() . 'ajax.js');
$objPage->addJavaScript($objConfig->jsPath() . 'mobileLanguage.js');
...
<center>
	<table>
		...
		<tr>
			<td colspan='3'><div id='info' class='info' name = 'info'>info</div></td>
		</tr>
	</table>
</center>
";
